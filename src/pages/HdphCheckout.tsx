...
const HdphCheckout = () => {
    ...
    const plan = {
        ...
        duration: "12 Months Care Plan",
        originalPrice: "12500",
        discountPrice: "4999",
        usdOriginalPrice: "149",
        usdPrice: "49",
        discount: isUSDFlow ? "Save 66%!" : "Save 60%!",
        isBestValue: true,
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 w-full">
                        ...
                        <div className="order-2 lg:order-1">
                            ...
                            <h1 className="text-[28px] md:text-[32px] leading-tight font-bold text-[#0D468B] mb-6 text-center">
                                You've selected the 1 Year Care Plan
                            </h1>

                            <h2 className="text-[18px] md:text-[20px] text-[#202020] mb-5 font-medium">
                                Benefits designed to support your long-term wellness
                            </h2>

                            <ul className="space-y-4">
                                <li className="flex items-start gap-3">
                                    <SolidCheckCircle />
                                    <span className="text-[#202020] text-[15px]">Health Assessment & Medical Evaluation</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <SolidCheckCircle />
                                    <span className="text-[#202020] text-[15px]">Blood Diagnostics with Home Sample Collection</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <SolidCheckCircle />
                                    <span className="text-[#202020] text-[15px]">Doctor Consultations & Expert Guidance</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <SolidCheckCircle />
                                    <span className="text-[#202020] text-[15px]">Personalised Diet Plan & Nutrition Consultations</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <SolidCheckCircle />
                                    <span className="text-[#202020] text-[15px]">12 Months of Yoga & Movement with HealthyDay</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <SolidCheckCircle />
                                    <span className="text-[#202020] text-[15px]">Monthly Expert Webinars & Live Q&A</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <SolidCheckCircle />
                                    <span className="text-[#202020] text-[15px]">Daily Lifestyle & Accountability Tracking</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <SolidCheckCircle />
                                    <span className="text-[#202020] text-[15px]">WhatsApp Reminders, Updates & Support</span>
                                </li>
                            </ul>
                        </div>
