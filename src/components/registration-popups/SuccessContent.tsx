...
<h2 className="text-[28px] sm:text-[32px] md:text-[35px] lg:text-[40px]" style={{ color: '#FFF', textAlign: 'center', fontFamily: 'Playball', fontWeight: 400, lineHeight: 'normal', margin: '0 auto' }}>
                ...
                <p className="text-[14px] sm:text-[15px] md:text-[17px] lg:text-[19px]" style={{ color: '#FFDD55', textAlign: 'center', fontFamily: 'Outfit', fontWeight: 600, lineHeight: 'normal', width: '100%', maxWidth: '20.57519rem', margin: '6px auto 0' }}>
            ...
            <div className="bg-white px-6 py-5 flex flex-col items-center gap-4">
                ...
                <div className="text-center flex flex-col items-center gap-2">
                    <p className="font-extrabold text-[18px] sm:text-[20px] md:text-[22px] lg:text-[25px] leading-[25px]" style={{ fontFamily: 'Outfit', wordBreak: 'break-word' }}>
                    ...
                    <span style={{ background: '#c1ddff', borderRadius: '5px', padding: '4px 24px', display: 'inline-block', fontFamily: 'Outfit', fontWeight: 700, color: '#0a386f', textAlign: 'center' }}>
                        {startLabelMatch ? (
                            <span className="text-[13px] sm:text-[14px] md:text-[16px] lg:text-[18px]">
                                Starts on {startLabelMatch[1]}<span className="text-[8px] sm:text-[9px] md:text-[10px] lg:text-[12px] align-super">{startLabelMatch[2]}</span> {startLabelMatch[3]}
                            </span>
                        ) : (
                            <span className="text-[13px] sm:text-[14px] md:text-[16px] lg:text-[18px]">Starts on {startLabel}</span>
                        )}
                    </span>
                </div>
                ...
                <div className="flex flex-col gap-1">
                    <p className="flex items-center justify-center gap-1 text-[10px] sm:text-[11px] md:text-[12px] lg:text-[13px]" style={{ color: '#0A386F', textAlign: 'center', fontFamily: 'Outfit', fontWeight: 700, lineHeight: 'normal' }}><SunIcon /> MOR - 5:30AM | 6:30AM | 7:30AM | 8:30AM IST</p>
                    <p className="flex items-center justify-center gap-1 text-[10px] sm:text-[11px] md:text-[12px] lg:text-[13px]" style={{ color: '#0A386F', textAlign: 'center', fontFamily: 'Outfit', fontWeight: 700, lineHeight: 'normal' }}><MoonIcon /> EVE - 4:30PM | 5:30PM | 6:30PM IST</p>
                </div>
