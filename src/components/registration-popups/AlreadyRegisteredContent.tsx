            ...
            <div className="bg-white px-6 py-5 flex flex-col items-center gap-4">
                ...
                <div className="text-center flex flex-col items-center gap-2">
                    ...
                    <span style={{ background: '#c1ddff', borderRadius: '5px', padding: '4px 24px', display: 'inline-block', fontFamily: 'Outfit', fontWeight: 700, color: '#0a386f', textAlign: 'center' }}>
                        {startLabelMatch ? (
                            <span className="text-[16px] sm:text-[18px] md:text-[20px] lg:text-[23px]">
                                Starts on {startLabelMatch[1]}<span className="text-[10px] sm:text-[11px] md:text-[13px] lg:text-[15px] align-super">{startLabelMatch[2]}</span> {startLabelMatch[3]}
                            </span>
                        ) : (
                            <span className="text-[16px] sm:text-[18px] md:text-[20px] lg:text-[23px]">Starts on {startLabel}</span>
                        )}
                    </span>
                </div>
                ...
                <div className="flex flex-col gap-1">
                    <p className="flex items-center justify-center gap-1 text-[11px] sm:text-[12px] md:text-[13px] lg:text-[14px]" style={{ color: '#0A386F', textAlign: 'center', fontFamily: 'Outfit', fontWeight: 600, lineHeight: 'normal' }}><SunIcon /> MOR - 5:30AM | 6:30AM | 7:30AM | 8:30AM IST</p>
                    <p className="flex items-center justify-center gap-1 text-[11px] sm:text-[12px] md:text-[13px] lg:text-[14px]" style={{ color: '#0A386F', textAlign: 'center', fontFamily: 'Outfit', fontWeight: 600, lineHeight: 'normal' }}><MoonIcon /> EVE - 4:30PM | 5:30PM | 6:30PM IST</p>
                </div>

                {/* WhatsApp notification */}
                <div className="flex items-center gap-2">
                    <img src={whatsappIcon} alt="WhatsApp" className="w-7 h-7 flex-shrink-0" />
                    <span className="text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px]" style={{ fontFamily: 'Outfit', fontWeight: 600, color: '#000', lineHeight: 'normal' }}>
